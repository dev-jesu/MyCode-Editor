...
<section class="card" style="max-width:520px;margin:24px auto;padding:18px;text-align:center">
  ...
  <p id="output" style="margin-top:1rem;color:#0f172a;font-weight:600;"></p>
</section>`, -1);

  ed_css.setValue(`body{font-family:system-ui;background:#f7fafc;margin:0}
h1{color:#0f172a}
#btn{padding:.75rem 1rem;border:0;border-radius:10px;background:#60a5fa;color:#08111f;font-weight:700;cursor:pointer}
#btn:hover{background:#3b82f6;color:#fff}`, -1);

  ed_js.setValue(`document.getElementById('btn').addEventListener('click',()=>{
  document.getElementById('output').textContent = 'Hello World from JavaScript 🚀';
});
console.log('Code Editor Ready!');`, -1);
}
